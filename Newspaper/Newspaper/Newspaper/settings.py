...
ACCOUNT_EMAIL_VERIFICATION = "none"  # Отключаем стандартную проверку allauth
ACCOUNT_EMAIL_CONFIRMATION_HMAC = False  # Отключаем HMAC-проверку
ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION = False  # Обязательная верификация
